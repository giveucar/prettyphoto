							...
							'<div class="pp_content">' +
								...
								'<div class="pp_fade"> <a href="#" class="pp_expand" title="Expand the image">Expand</a>' +
									...
									'<div class="pp_details">' +
										'<div class="pp_nav"> <a href="#" class="pp_arrow_previous">Previous</a>' +
											'<p class="currentTextHolder">0/0</p> <a href="#" class="pp_arrow_next">Next</a> </div>' +
										'<p class="pp_description"></p>' +
										'<div class="pp_social">{pp_social}</div> <a class="pp_close" href="#">Close</a> </div>' +
								'</div>' +
							'</div>' +
						'</div>' +
					'</div>' +
	  ...
	  $ppt.css('opacity',0).show();
		...
		*/
		...
		function _build_overlay(caller){
			...
			$(settings.markup_holder).append(settings.markup); // Inject the markup
		...
		return this.off('click.prettyphoto').on('click.prettyphoto',
	  $.prettyPhoto.initialize); // Return the jQuery object for chaining. The unbind method is used to avoid click conflict when the plugin is called more than once
	};
